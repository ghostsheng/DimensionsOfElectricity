...
public class CustomRelalayout extends RelativeLayout implements View.OnClickListener {
    ...
    private void init(Context context) {
        ...
        ImageView num_add =  view.findViewById(R.id.num_image_add);
        ImageView num_minus = view.findViewById(R.id.num_image_minus);
        num_price =  view.findViewById(R.id.num_edit_price);
                ...
                switch (id) {
                    case R.id.num_image_minus:
                        if (num > 1) {
                            ...
                            Toast.makeText(context, "最后一个了哦", Toast.LENGTH_SHORT).show();
                            break;
                        }
                        break;
